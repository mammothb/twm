...
{
    [Fact]
    public void MapGaps_Null_IsNone() => ConfigMapping.MapGaps(null).ShouldBe(Gaps.None);
    ...
    [Fact]
    public void MapWorkspaces_Null_IsNone() => ConfigMapping.MapWorkspaces(null).ShouldBeNull();
